    ...
    <form method="POST" class="grid grid-cols-1 gap-6">
        ...
        <label class="block">
            ...
            <select name="country" class="block w-full mt-1 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                ...
                <option value="Canada" <?php if (isset($oldFormData['country'])) echo $oldFormData['country'] === 'Canada' ? 'selected' : ''; ?>>Canada</option>
                <option value="Mexico" <?php if (isset($oldFormData['country'])) echo $oldFormData['country'] === 'Mexico' ? 'selected' : ''; ?>>Mexico</option>
                <option value="Czech republic" <?php if (isset($oldFormData['country'])) echo $oldFormData['country'] === 'Czech republic' ? 'selected' : ''; ?>>Czech republic</option>
            </select>
